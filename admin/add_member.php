...
?>
    <div class="content">
            <div class="container-fluid">
              <form id="form1" name="form_1" onsubmit="return validate()" method="POST" action="<?php echo $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <span class="help-block <?php if($errfno) echo 'invalid'; ?>" id="errfno"><?php echo $errfno?></span>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <span class="help-block <?php if($erremail) echo 'invalid'; ?>" id="erremail"><?php echo $erremail?></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <span class="help-block <?php if($errfname) echo 'invalid'; ?>" id="errfname"><?php echo $errfname?></span>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <span class="help-block <?php if($errlname) echo 'invalid'; ?>" id="errlname"><?php echo $errlname;?></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <span class="help-block <?php if($errphno) echo 'invalid'; ?>" id="errphno"><?php echo $errphno?></span>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <span class="help-block <?php if($errdate) echo 'invalid'; ?>" id="errdate"><?php echo $errdate?></span>
  ...
  function validate() {
    var submit= true;
      if (document.form_1.flatno.value == '') 
      {
        // alert("Please provide Book Name");
        // document.form_1.flatno.focus();  
        document.getElementById('errfno').innerHTML="Please enter Flat Number"; 
         document.getElementById('errfno').classList.add('invalid');


        submit=false;
      }
      if (document.form_1.email_id.value == '') {
        // alert("Please provide name of author");
        // document.form_1.author.focus();
        document.getElementById('erremail').innerHTML="Please enter Email"; 
         document.getElementById('erremail').classList.add('invalid');
        submit=false;
      }
       if (document.form_1.fname.value == '') {
        // alert("Please provide Proper price");

        // document.form_1.author.focus();
        document.getElementById('errfname').innerHTML="Please enter First Name"; 
         document.getElementById('errfname').classList.add('invalid');

        submit=false;
      }
      if (document.form_1.lname.value == '') {
        // alert("Please provide Proper price");

        document.form_1.lname.focus();
        document.getElementById('errlname').innerHTML="Please enter Last Name"; 
         document.getElementById('errlname').classList.add('invalid');

        submit=false;
      }
      if (document.form_1.arrive_date.value == '') {
        // alert("Please provide Proper price");

        // document.form_1.author.focus();
        document.getElementById('errdate').innerHTML="Please enter arrival date"; 
         document.getElementById('errdate').classList.add('invalid');

        submit=false;
      }
      if (document.form_1.phone1.value == '') {
        // alert("Please provide Proper price");

        // document.form_1.author.focus();
        document.getElementById('errphno').innerHTML="Please enter Phone Number"; 
         document.getElementById('errphno').classList.add('invalid');
